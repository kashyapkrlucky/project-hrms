...
function NotFound() {
  return (
    <main className="flex flex-col h-screen gap-6 p-20 grid place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        <p className="text-base font-medium text-indigo-600">404</p>
